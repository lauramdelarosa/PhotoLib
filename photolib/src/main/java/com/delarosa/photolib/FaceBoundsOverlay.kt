...
import com.delarosa.photolib.models.Facing
import com.delarosa.photolib.models.Orientation
...
class FaceBoundsOverlay @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        facesBounds.forEach {
            val centerX = computeFaceBoundsCenterX(
                canvas.width.toFloat(),
                scaleX(it.box.exactCenterX(), canvas)
            )
            val centerY = computeFaceBoundsCenterY(
                canvas.height.toFloat(),
                scaleY(it.box.exactCenterY(), canvas)
            )
